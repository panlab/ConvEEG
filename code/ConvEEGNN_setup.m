function net = ConvEEGNN_setup(net)
%% Convolution layer
inputmaps = 1;
...
fan_in = inputmaps*net.layers{3}.perNeural;
rng('shuffle');
net.layers{4}.k = mat2cell((rand(net.layers{4}.perNeural,fan_in)-0.5) * 2 ...
    * sqrt(6 / (net.layers{4}.perNeural + net.layers{3}.outputmaps*net.layers{3}.perNeural)),ones(1,net.layers{4}.perNeural),fan_in)';
net.layers{4}.b = zeros(net.layers{4}.outputmaps*net.layers{4}.perNeural,1);
%% Output layer
fvnum = net.layers{4}.perNeural;
